...
const ManufacturerTableHeader = ({
    ...
    const handleSuccessfulAdd = () => {
        ...
        setTimeout(() => {
            showToast(`Successfully added the Manufacturer`, 'success');
            fetchHistory();
        }, 500);
    ...
    return (
        <>
            ...
            <ManufacturerAdd open={addNewRetailerDialog} onClose={() => setAddNewRetailerDialog(false)} onSuccessfulAdd={handleSuccessfulAdd} onError={handleAddError} />
            </Card>
        </>
    );
};
