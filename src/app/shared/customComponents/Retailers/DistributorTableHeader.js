...
import DistributorAdd from './DistributorAdd';
...
const DistributorTableHeader = ({
    ...
    const handleSuccessfulAdd = () => {
        ...
        setTimeout(() => {
            showToast(`Successfully added the Distributor`, 'success');
            fetchHistory();
        }, 500);
    ...
    return (
        <>
            ...
            <DistributorAdd open={addNewRetailerDialog} onClose={() => setAddNewRetailerDialog(false)} onSuccessfulAdd={handleSuccessfulAdd} onError={handleAddError} />
            </Card>
        </>
    );
};

export default DistributorTableHeader;
