...
const About = ({ record, setRecord, fetchAgronomist }) => {
    ...
    return (
        <React.Fragment>
            <Typography variant={'h2'} mb={3}>Agronomist Info</Typography>
            <JumboCardQuick
                title={`ID: ${record._id}`}
                action={
            ...
            >
                ...
                {overviewEditModalOpen && <OverviewEditModal record={record} setOverviewEditModalOpen={setOverviewEditModalOpen} fetchAgronomist={fetchAgronomist}/>}
