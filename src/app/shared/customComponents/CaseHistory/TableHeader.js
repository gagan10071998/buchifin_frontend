...
import AddRetailers from '../Retailers/RetailerAdd';
...
const TableHeader = ({
    ...
    return (
        <>
            ...
            <AddRetailers open={addNewRetailerDialog} onClose={() => setAddNewRetailerDialog(false)} onSuccessfulAdd={handleSuccessfulAdd} onError={handleAddError} />
            </Card>
        </>
    );
};
